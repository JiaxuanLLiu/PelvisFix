...
from spine_transformer_util import box_ops
from spine_transformer_util.misc import (NestedTensor, nested_tensor_from_tensor_list)
...
class SpineTR(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_queries, feature_map_dim=[4, 4, 4],aux_loss=False):
        ...
        self.proj = nn.Linear(feature_map_dim[0] * feature_map_dim[1] * feature_map_dim[2], 1)  # 1
