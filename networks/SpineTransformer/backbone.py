...
from networks.SpineTransformer.resnet_no_pool import generate_ResNet
...
class Backbone(nn.Module):
    ...
    def __init__(self, num_channels: int, model_depth: int):
        super().__init__()
        self.body = generate_ResNet(model_depth)
...
def build_backbone(args):
    ...
    backbone = Backbone(num_channels=512, model_depth=18)
